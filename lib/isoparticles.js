...
if (typeof window !== "undefined" && typeof document !== "undefined") {
  Object.isoparticlesDeepExtend = function(destination, source) {
  ...
  particlesJS = isoparticles();
} else {
  particlesJS = function() { return {}; };
}

module.exports = particlesJS;

function isoparticles() {
  var pJS = function(tag_id, params){
    ...
    if(params){
      Object.isoparticlesDeepExtend(pJS, params);
    }
    ...
    pJS.fn.canvasSize = function(){
      ...
      if(pJS.interactivity.events.resize){
        window.addEventListener('resize', pJS.fn.handleResize);
      }
    };
    ...
    pJS.fn.vendors.destroypJS = function(){
      if (pJS.interactivity.events.resize) {
        window.removeEventListener('resize', pJS.fn.handleResize);
      }
    ...
    xhr.onreadystatechange = function (data) {
      if(xhr.readyState == 4){
        if(xhr.status == 200){
          ...
          var pJS = particlesJS(tag_id, params);
